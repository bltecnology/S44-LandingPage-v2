...
>
  ...
  <div className="quemsomos-text">
    <p>
      ...
      completas e eficientes para o transporte de cargas. Com mais de 10 anos de
      experiência no mercado, nossa missão é proporcionar aos nossos clientes a
      segurança e a agilidade necessárias para que seus produtos cheguem ao
      destino com pontualidade e confiança.
    </p>
    <a href="/quem-somos" className="btn-yellow">
      Conheça melhor a S44!
    </a>
  </div>
</section>
    ...
    <QuemSomos/>
      ...
      <section className="services" id="servicos">
        ...
        <div className="services__grid">
          ...
          <a href="/banner-cargas-perigosas">
            <article className="service-card">
              <div className="service-card__icon">
        ...
        <div className="services__cta">
          <a href="/servicos" className="btn btn--dark">
            Saiba mais sobre →
          </a>
        </div>
      </section>
