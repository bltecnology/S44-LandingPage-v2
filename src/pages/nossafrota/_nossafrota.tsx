...
export const NossaFrota = () => {
  ...
  return (
    <>
      ...
      >
        <div className="frota-content-wrapper">
          <div className="frota-text-content-in-banner">
            <span className="subtitle">Saiba mais sobre</span>
            <h1>Nossa Frota</h1>
            <p>
          ...
          <div className="frota-main-image-in-banner">
            <img
              src={caminhaoFrotaPrincipal}
              alt="Caminhões S44"
              className="main-truck-image-in-banner"
            />
          </div>
        </div>
      </section>
